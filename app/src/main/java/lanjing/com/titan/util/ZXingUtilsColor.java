...
public class ZXingUtilsColor {
     ...
     * @return 合成后的bitmap
     */
    public static Bitmap createQRImage(Context context, String data, int margin) {
...
//                        int red = (int)(45 - (45.0) / heightPix * (y + 1));
//                        int green = (int)(139 - (139.0) / heightPix * (y + 1));
//                        int blue =  (int)(233 - (233.0) / heightPix * (y + 1));
//                        Color color = new Color();
//                        int colorInt = color.argb(255, red, green, blue); 064A8B
                        // 修改二维码的颜色，可以分别制定二维码和背景的颜色
//                        pixels[y * widthPix + x] = bitMatrix.get(x, y) ? colorInt: 16777215;
                        pixels[y * widthPix + x] = 0xff064A8B;
                    } else {
