...
public class BuySixOneAdapter extends BaseQuickAdapter<SixTradeResponse.Data.BuydataBean, BaseViewHolder> {

    public BuySixOneAdapter(int layoutResId, @Nullable List<SixTradeResponse.Data.BuydataBean> data) {
