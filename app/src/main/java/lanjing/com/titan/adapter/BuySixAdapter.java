...
public class BuySixAdapter extends BaseQuickAdapter<SixTradeResponse.BuydataBean, BaseViewHolder> {

    public BuySixAdapter(int layoutResId, @Nullable List<SixTradeResponse.BuydataBean> data) {
