...
public class SellSixOneAdapter extends BaseQuickAdapter<SixTradeResponse.SelldataBean, BaseViewHolder> {

    public SellSixOneAdapter(int layoutResId, @Nullable List<SixTradeResponse.SelldataBean> data) {
