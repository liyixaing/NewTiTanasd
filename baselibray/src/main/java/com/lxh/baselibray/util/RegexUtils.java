...
public final class RegexUtils {
    ...
    public static boolean isDigitalAndLetter(final CharSequence input){
        return isMatch(RegexConstants.DIGITAL_LETTER,input);
    }
    /**
    ...
    public static boolean isLoginPwd(final CharSequence input){
        return isMatch(RegexConstants.LOGIN_PWD,input);
    }

    public static boolean isAccount(final CharSequence input){
        return isMatch(RegexConstants.LOGIN_PWD,input);
    }
    /**
