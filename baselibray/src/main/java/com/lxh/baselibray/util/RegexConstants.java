...
public final class RegexConstants {
    ...
    /**
     * 可以包含数字、字母、下划线，并且要同时含有数字和字母，且长度要在6-18位之间
     */
    public static final String LOGIN_PWD="^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z_]{8,18}$";
    /**
     * 数字加字母组合
     */
    public static final String DIGITAL_LETTER="^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]$";
}
